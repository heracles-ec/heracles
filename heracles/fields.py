...
__call__ is an abstract method in Field, implemented in child classes defined here
TODO - fix the messy exlude solution for autoclass abstract function

.. currentmodule:: heracles.fields
